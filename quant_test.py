...
net = qresnet20_cifar(w_bits = args.w, a_bits = args.a)
# net = resnet20_cifar()
...
for epoch in range(start_epoch, end_epoch):
    if epoch in [start_epoch + ep * 0.10,start_epoch + ep * 0.3,start_epoch + ep * 0.6,start_epoch + ep * 0.8, start_epoch + ep * 0.9]:
        print('lr decrease')
